...
<div style="margin-left:3%;" >
			<form action="CancelServlet" method="post">
				<div class="col-sm-6 col-md-6">
					<div><h2>Cancel Flights</h2>
					</div><br>
						     <div class="form-group">
						      <label for="Destination">Ticketid</label>
						      <input type="text" class="form-control" placeholder="Enter ticket id:" name="ticketid">
						     </div>
						     <button type="submit" class="btn btn-primary">Cancel Ticket</button>
				</div>
			</form>	
		</div>	
 <% String cancel = (String)request.getAttribute("cancelled"); 
 if(cancel!=null) {%>
 	<h4 class="error"><%=cancel %></h4>
 <%} %>
